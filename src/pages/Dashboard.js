                ...
                <div className="grid grid-cols-12">
                    ...
                    <nav className="grid grid-cols-12 col-span-12 bg-white drop-shadow-lg">
                        <div className="col-start-2 col-end-13 flex justify-between">
                            <img className="col-span-1 col-start-2 h-16" src="./ease-it 1.jpg" alt="ease-it logo" />
                            <div className="col-start-4 col-end-13 flex self-center uppercase">
                                <ul className="col-start-4 col-end-12 flex justify-items-center">
                                    ...
                                    <li
                                        className="self-center mr-4 hover:border-b-4 hover:border-clr-4 hover:-mb-1 focus:border-b-4 focus:border-clr-4 font-bold text-clr-2 text-xs">
                                        <a href="#">Search <i
                                            className="fa fa-search self-center text-clr-2 font-semibold text-center p-1 bg-clr-3 rounded-3xl"
                                            aria-hidden="true"></i>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <main className="col-start-2 col-end-12 grid grid-cols-12 gap-x-10 gap-y-0 mt-8 mb-4">
                        <section className="col-span-4 row-start-2 row-end-5 grid grid-cols-1 grid-rows-2 gap-x-2">
                            <h1 className="text-clr-2 font-serif_display text-2xl pb-2 tracking-wider">Dashboard</h1>
                            <div className="bg-clr-4 row-start-2 row-end-3 h-screen border-2 border-black/40 drop-shadow-lg">
                        ...
                        <section className="col-start-5 col-end-13 row-start-2 row-end-3 flex flex-col pt-14 ml-10">
                        ...
                        <div className="bg-clr-2 text-white text-sm flex justify-between p-4 px-6">
                            <a className="flex self-center bg-clr-5 font-semibold text-black text-center p-1 px-4 shadow-xl"
                                ...
                                <span className="text-white h-5 w-5 ml-2">
                                    <img src="./playstore.png" alt="google playstore icon" />
                                </span>
                            </a>
                        ...
                        <div className="flex flex-col bg-clr-3 p-4">
                            <div className="flex px-8 py-4">
                                <div className="flex flex-col justify-evenly ml-10 mr-20">
                                    <img className="w-1/2" src="./ease-it 1.svg" alt="ease-it logo" />
                                    ...
                                    <div className="ml-4 text-sm flex flex-col">
                                        ...
                                        <div className="w-full flex justify-between mt-1">
                                            <span className="h-4 w-4 text-clr-3 bg-clr-2 text-center text-xs rounded-3xl self-center">
                                                <i className="fa fa-facebook" aria-hidden="true"></i>
                                            </span>
                                            <span
                                                className="h-4 w-4 text-clr-3 self-center text-center text-clr-2 text-xs rounded-3xl"><img
                                                    src="./instagram.svg" alt="instagram logo" /></span>
                                            <span className="h-4 w-4 text-clr-3 bg-clr-2 text-center text-xs rounded-3xl self-center">
                                            ...
                                            <span
                                                className="h-4 w-4 text-clr-3 self-center text-center text-clr-2 text-xs rounded-3xl border border-clr-2">
