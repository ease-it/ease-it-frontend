        ...
        <>
            <nav className=" grid grid-cols-12 col-span-12 bg-white drop-shadow-lg">
                <div className="col-start-2 col-end-13 flex justify-between">
                    ...
                    <div className="md:col-start-4 hidden md:col-end-13 md:flex self-center uppercase">
                        ...
                        <button
                            className="self-center bg-clr-4 rounded-2xl shadow-lg text-white text-xs tracking-wider p-2 mr-4 "><a href="/signup">Signup?Login</a>
                        </button>
                    </div>
                </div>
            </nav>
